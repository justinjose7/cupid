        ...
        <div className='box-profile-form'>
            <Dropzone
                ...
                <div className="profile-img">
                        <img src={this.state.uploadedFileCloudinaryUrl} alt="Drop an image or click to select a file to upload." onError={(e)=>{e.target.src="http://res.cloudinary.com/dbormtzbg/image/upload/v1524204692/uploadPlaceholder.jpg"}}/>
                </div>
            </Dropzone>
